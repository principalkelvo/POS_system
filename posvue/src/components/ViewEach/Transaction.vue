      ...
      <h2
          ...
          >
            ...
            <div class="columns is-multiline has-background-white box">
              ...
              <div class="column">
                <p> <strong>Transaction Id : </strong> 00233  </p>
                <p> <strong>Product Purchased : </strong>product A, productB,</p>
                <p> <strong>Transaction Date : </strong> 2/01/2023  </p>
                ...
                <p> <strong>VAT id : </strong> M-pesa </p>
                <p> <strong>Location : </strong> Nai </p>
              </div>


                <div class="column ">
                <p> <strong>Supplier : </strong> Loris name  </p>
