      ...
      <h2
          ...
          >
            ...
            <div class="columns is-multiline has-background-white box">
              ...
              <div class="column">
                <p> <strong>Sale Id : </strong> 00233  </p>
                ...
                <p> <strong>Sale Date : </strong> 2/01/2023  </p>
                <p> <strong>Products Sold : </strong> 200 items  </p>
              </div>

                <div class="column ">
                <p> <strong>Sale Branch : </strong> Branch A </p>
                <p> <strong>Sold by : </strong> Loris name  </p>
